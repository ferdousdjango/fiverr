...
CookieBanner.setButton({
  ...
  "class"       : "cbc-button-settings btn my_btn",
  "enable"      : true
});
CookieBanner.setButton({
  "type"        : "banner",
  ...
  "class"       : "cbc-button-accept btn my_btn",
  "enable"      : true
});
CookieBanner.setButton({
  "type"        : "banner",
  ...
  "class"       : "cbc-button-reject btn my_btn",
  "enable"      : true
});
CookieBanner.setButton({
  "type"        : "tab",
...
CookieBanner.setContent({
  ...
  "template"    : "<p>We use cookies to improve your experience and analyze site usage. Read <a href='privacy.html' target='_blank'> Cookie Policy</a>.</p>"
});
...
CookieBanner.init({
  "content" : [{
      ...
      "cookies"     : [{
        ...
        "position"    : 2,
        "checkbox"    : false,
        "title"       : "<span class='banner_btn'>Strictly Necessary Cookies</span>",
      ...
      "position"    : 3,
      "checkbox"    : true,
      "title"       : "<span class='banner_btn'>Performance & Analytics Cookies</span>",
  ...
  console.log("On button Click Data =:", data);
});